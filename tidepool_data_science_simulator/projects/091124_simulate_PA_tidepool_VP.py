...
if __name__ == "__main__":
    ...
    # activity_names = ['Biking (Indoor or Outdoor)', 'Jogging/Running (Indoor or Outdoor)', 'Strength Training, Weight Lifting']
    ...
    save_root = '/home/mdhaliwal/data-science-simulator/tidepool_data_science_simulator/projects/PA_simulations_tidepoolVP'
    ...
    if use_preset:
        experiment_name += '_preset'
    else:
        experiment_name += '_nopreset'
        
    save_root = os.path.join(save_root, experiment_name)
    if not os.path.isdir(save_root):
        os.makedirs(save_root)
    
    starting_glucose_vals = [70, 90, 110, 130, 150, 170, 190, 210, 230, 250]
    activity_durations = [30, 45, 60, 90]

    # load cir, isf and egp vals
    vp_info_path = '/home/mdhaliwal/data-science-simulator/tidepool_data_science_simulator/projects/tidepool_helmsley_preset_virtual_patients_sep_2024.csv'
        ...
        for activity_index, activity in enumerate(activity_names):
            ...
            for starting_glucose in starting_glucose_vals:
                for pa_duration in activity_durations:
                    ...
                    sim_name = f"vp_{vp_index}_{cir}_{isf}_{egp}_{starting_glucose}_{pa_duration}"
