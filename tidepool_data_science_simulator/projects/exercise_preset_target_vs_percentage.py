...
def build_metabolic_sensitivity_sims(start_glucose_value=110, basal_rate=0.3, cir=20.0, isf=150.0, target_range_min=100, target_range_max=120, carb_timeline=None, pump_carb_timeline=None, bolus_timeline=None, duration_hrs=1, controller_class=LoopController):
    """
    ...
    t0, patient_config = get_canonical_virtual_patient_model_config(start_glucose_value = start_glucose_value, basal_rate=basal_rate, cir=cir, isf=isf, carb_timeline=carb_timeline) # patient has many attributes e.g. starting glucose (default: 110), recommendatio accept probability, etc.    
...
if __name__ == "__main__":
    ...
    # carb_timeline = None
    t0 = DATETIME_DEFAULT
    carb_timeline = CarbTimeline([t0], [Carb(30.0, "g", 180)])
